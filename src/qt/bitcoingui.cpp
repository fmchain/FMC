...
{
    resize(850, 550);
    setWindowTitle(tr("FortuneManagementCoin"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a FortuneManagementCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/coin"), tr("&About FortuneManagementCoin"), this);
    aboutAction->setToolTip(tr("Show information about FortuneManagementCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for FortuneManagementCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("FortuneManagementCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("FortuneManagementCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FortuneManagementCoin network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid FortuneManagementCoin address or malformed URI parameters."));
    }
